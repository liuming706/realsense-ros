...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'rgb_camera.global_time_enabled',            'default': 'true', 'description': 'Timeout(seconds) between consequtive reconnection attempts'},
                           {'name': 'depth_module.global_time_enabled',            'default': 'true', 'description': 'Timeout(seconds) between consequtive reconnection attempts'},
                           {'name': 'motion_module.global_time_enabled',            'default': 'true', 'description': 'Timeout(seconds) between consequtive reconnection attempts'},
                           {'name': 'rgb_camera.profile',            'default': '640x480x30', 'description': 'Timeout(seconds) between consequtive reconnection attempts'},
                           {'name': 'depth_module.profile',            'default': '640x480x30', 'description': 'Timeout(seconds) between consequtive reconnection attempts'},
                          ]
